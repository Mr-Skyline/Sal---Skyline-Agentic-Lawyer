...
| 2026-04-08 | Post-merge CLI paths | `src/sal/verify_setup.py` docstring + status lines: `py -m src.sal.verify_setup`, `scripts/oauth_login.py`, `docs/supabase_schema.sql`, `py -m src.sal.sync_worker`; `scripts/oauth_google_checklist.py` / `oauth_diagnose.py`; `STRUCTURE.md` run hint. |
