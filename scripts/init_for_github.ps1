...
# Run from repo root:  powershell -ExecutionPolicy Bypass -File .\scripts\init_for_github.ps1
# First push (finds Git if not on PATH): use scripts\PUSH_NOW.ps1 instead.
