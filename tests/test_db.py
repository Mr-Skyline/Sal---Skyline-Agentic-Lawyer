...
from db import insert_review_export_meta, supabase_client, upsert_correspondence_thread
...
class TestUpsertCorrespondenceThread:
    def test_noop_when_no_supabase(self):
        with patch("db.supabase_client", return_value=None):
    ...
    def test_exception_in_upsert_is_caught(self):
        ...
        with patch("db.supabase_client", return_value=mock_cli):
